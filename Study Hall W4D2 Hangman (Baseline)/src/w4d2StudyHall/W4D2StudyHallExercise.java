...
menuCharacter = uma.next().charAt(0);

if( menuCharacter == 'p')
{

	System.out.println("play the game command recognised");
System.out.println("please enter a command letter followed bya return!");
...
System.out.println("Mahesh, please enter a command letter followed by a return!");
...
System.out.println("Thanks for plaiyng mahesh");
}
